...
class FuseUtils {
    ...
    static hasPermission(authArr, userRole) {
        ...
        if (userRole === undefined) {
            userRole = useSelector(({auth}) => auth.user.role);
        }
        // Check for the permission
        if (userRole[auth.slug] === null || userRole[auth.slug] === undefined) {
            return false;
        }
        if (userRole[auth.slug][auth.permission] === null || userRole[auth.slug][auth.permission] === undefined) {
            return false;
        }
